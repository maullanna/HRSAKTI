...
<div class="login-container">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-form">
            <img src="{{ URL::asset('storage/logos/ams_logo_1762390189.png') }}" alt="Logo" class="image">
            ...
            <form method="POST" action="{{ route('employee.login.post') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="pin_code" type="password" class="form-control @error('pin_code') is-invalid @enderror"
                            name="pin_code" required autocomplete="current-password"
                            placeholder="Enter your PIN code">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" id="togglePinCode">
                                <i class="mdi mdi-eye" id="togglePinCodeIcon"></i>
                            </button>
                        </div>
                    </div>
                    @error('pin_code')
...
<script>
    ...
    // Toggle PIN code visibility
    const togglePinCodeBtn = document.getElementById('togglePinCode');
    if (togglePinCodeBtn) {
        togglePinCodeBtn.addEventListener('click', function() {
            const pinCodeInput = document.getElementById('pin_code');
            const toggleIcon = document.getElementById('togglePinCodeIcon');
