                ...
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="{{ route('overtime.approve', $overtime) }}" method="POST" style="display: inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Are you sure you want to approve this overtime request?')">
                                                <i class="mdi mdi-check"></i>
                                            </button>
                                        </form>
                                        <form action="{{ route('overtime.reject', $overtime) }}" method="POST" style="display: inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to reject this overtime request?')">
                            ...
                            @empty
                            <tr>
                                <td colspan="9" class="text-center">No overtime requests pending approval.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
