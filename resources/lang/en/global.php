...
return [
    ...
    'logout_confirmation_confirm'           => 'Yes, Logout',

    'logout_processing'                    => 'Logging out...',

    'logout_processing_text'               => 'Processing logout...',
    ...
    '403' => "You don't have the permissions to access this page!",
    ...
    'menu' => [
        ...
        'overtime_reports' => 'Overtime Reports',
        'leaves' => 'Leaves',
        'leaves_cuti_tunjangan' => 'Leaves (Cuti & Tunjangan)',
        'salaries' => 'Salaries',
        'salaries_slip_gaji' => 'Salaries (Slip Gaji)',
        'trainings' => 'Trainings',
        'settings' => 'Settings',
    ],
    ...
    'dashboard' => [
        'welcome' => 'Welcome',
        'todays_attendance_status' => 'Today\'s Attendance Status',
        'present_on_time' => 'Present - On Time',
        'present_late' => 'Present - Late',
        'not_checked_in' => 'Not Checked In',
        'please_check_in' => 'Please check in to record your attendance',
        ...
        'recent_overtime' => 'Recent Overtime',
        'no_attendance_records' => 'No attendance records',
        'no_leave_requests' => 'No leave requests',
        'no_overtime_requests' => 'No overtime requests',
        'my_training_overview' => 'My Training Overview (Last 12 Months)',
        'my_training_statistics' => 'My Training Statistics',
        'total_trainings' => 'Total Trainings',
        'completed' => 'Completed',
        'ongoing' => 'Ongoing',
        'my_training_this_month' => 'My Training This Month',
        'employee' => 'Employee',
        'title' => 'Title',
        'category' => 'Category',
        'start_date' => 'Start Date',
        'end_date' => 'End Date',
        'status' => 'Status',
        'no_training_records' => 'No training records for this month.',
        'late' => 'Late',
        'check_in' => 'Check In',
    ],
