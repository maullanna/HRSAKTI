...
class AddSelfReferenceFieldsToEmployeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('employees', function (Blueprint $table) {
            // Add self-reference fields for wadir, sdm, director, and section employee
            if (!Schema::hasColumn('employees', 'id_wadir_employee')) {
                $table->unsignedInteger('id_wadir_employee')->nullable()->after('id_section');
            }
            ...
            if (!Schema::hasColumn('employees', 'id_section_employee')) {
                $table->unsignedInteger('id_section_employee')->nullable()->after('id_director_employee');
            }
        });
        ...
        try {
            DB::statement('ALTER TABLE `employees` 
                    ADD CONSTRAINT `employees_id_wadir_employee_foreign` 
        ...
        try {
            DB::statement('ALTER TABLE `employees` 
                    ADD CONSTRAINT `employees_id_sdm_employee_foreign` 
        ...
        try {
            DB::statement('ALTER TABLE `employees` 
                    ADD CONSTRAINT `employees_id_director_employee_foreign` 
        ...
        try {
            DB::statement('ALTER TABLE `employees` 
                    ADD CONSTRAINT `employees_id_section_employee_foreign` 
    ...
    public function down()
    {
        ...
        try {
            DB::statement('ALTER TABLE `employees` DROP FOREIGN KEY `employees_id_wadir_employee_foreign`');
        } catch (\Exception $e) {
            // Ignore
        }

        try {
            DB::statement('ALTER TABLE `employees` DROP FOREIGN KEY `employees_id_sdm_employee_foreign`');
        } catch (\Exception $e) {
            // Ignore
        }

        try {
            DB::statement('ALTER TABLE `employees` DROP FOREIGN KEY `employees_id_director_employee_foreign`');
        } catch (\Exception $e) {
            // Ignore
        }

        try {
            DB::statement('ALTER TABLE `employees` DROP FOREIGN KEY `employees_id_section_employee_foreign`');
        } catch (\Exception $e) {
            // Ignore
        }
